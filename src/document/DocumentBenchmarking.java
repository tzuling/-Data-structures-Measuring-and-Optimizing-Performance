...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			String fileStr = getStringFromFile(textfile, numToCheck);
			
			long startTime = System.nanoTime();
			BasicDocument basicdoc = new BasicDocument(fileStr);
			basicdoc.getFleschScore();
			long endTime = System.nanoTime();
			System.out.print((endTime-startTime)/1000000000.0 + "\t");
			
			startTime = System.nanoTime();
			EfficientDocument efficdoc = new EfficientDocument(fileStr);
